...
String getHours = JOptionPane.showInputDialog("How many hours have you spent on coding this week?");
Double Hours = Double.parseDouble(getHours);
	// 2. If it is less than or equal to 2, tell them to stop watching YouTube and
	// write code instead.
if (Hours <= 2) {
	JOptionPane.showMessageDialog(null, "Stop watching youtube and go code.");
}
